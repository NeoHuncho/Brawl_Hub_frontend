        ...
        <>
          <SafeAreaView style={{ zIndex: 1 }}>
            ...
            <View style={{ backgroundColor: colors.background }}>
              ...
              <ScrollView ref={(ref) => setRef(ref)} style={{ zIndex: 1 }}>
                  ...
                  <View style={{ marginTop: 10 }}>
                    ...
                    <TouchableOpacity onPress={() => handleOverallStatsPress()}>
                      ...
                      >
                        <View style={{ flexDirection: "row" }}>
                          ...
                          >
                            {getTranslation("Show Overall Player Stats")}
                          </Text>
                        </View>
                      </View>
                    </TouchableOpacity>
                    ...
                    <View style={{ marginTop: 30 }}>
                      ...
                      <View style={{ marginTop: 18, marginBottom: 80 }}>
                        ...
                        >
                          {getTranslation("Player Stats by Mode")}
                        </Text>
                        <CarouselModule
                          dataType="mode"
                          style={styleIndex}
                        ...
                        >
                          {getTranslation("Player Stats by Map")}
                        </Text>
                        <CarouselModule
                          dataType="map"
                          style={styleIndex}
                        ...
                        >
                          {getTranslation("Player Stats by Brawler")}
                        </Text>
                        <CarouselModule
                          dataType="brawler"
                          style={styleIndex}
                        ...
                        <View style={{ marginBottom: 250 }}>
                          ...
                          >
                            {getTranslation("Player Stats by Teams")}
                          </Text>
                          <CarouselModule
                            dataType="team"
                            style={styleIndex}
