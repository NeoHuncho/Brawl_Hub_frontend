...
export default function PlayerStatsMoreInfo() {
  ...
  processPlayerStats(carouselInfo.seasonIndex, carouselInfo.gameType, carouselInfo.name, carouselInfo.type)
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      />
      <TouchableHighlight style={{ position: "absolute", left: 5, top: 125 }}>
        <Ionicons
      ...
      <ScrollView>
        {carouselInfo.type == "mode" && (
          <>
            ...
            <CarouselModule dataType="map" style={preferencesCarouselStored.styleIndex} sort={preferencesCarouselStored.sortIndex} />
          </>
        )}
        <Text
          style={[
        ...
        <CarouselModule dataType="brawler" style={preferencesCarouselStored.styleIndex} sort={preferencesCarouselStored.sortIndex} />

        <Text style={styles.categoryName}>Player Stats by Teams</Text>
        <CarouselModule dataType="team" style={preferencesCarouselStored.styleIndex} sort={preferencesCarouselStored.sortIndex} />
      </ScrollView>
    </SafeAreaView>
  );
}
